...
$$ s^n + \alpha_n s^{n-1} + \alpha_{n-1} s^{n-2} + ... + \alpha_1=0 \tag{3} $$

where, <span style="font-family:Bodoni MT;font-style:italic;font-size:18px">&alpha;<sub>i</sub></span> for <span style="font-family:Bodoni MT;font-style:italic;font-size:18px">i=1, 2, ..., n</span> depends on <span style="font-family:Bodoni MT;font-style:italic;font-size:18px">A, B, K</span>. </br>
